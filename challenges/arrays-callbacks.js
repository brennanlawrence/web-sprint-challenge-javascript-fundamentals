...
*/
const displayNames = [];
zooAnimals.forEach(unshiftNames);

function unshiftNames(item, index){
  displayNames.unshift(`Name: ${zooAnimals[index].animal_name},  Scientific: ${zooAnimals[index].scientific_name}`);
  return displayNames;
}
